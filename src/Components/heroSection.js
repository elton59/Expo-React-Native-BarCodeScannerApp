    ...
    return (
      <View style={styles.container}>
          <View style={styles.circlesContainer}>
              ...
              <TouchableOpacity style={styles.circle_3} onPress={() =>navigation.navigate('Scanner')}/>
              <TouchableOpacity style={styles.circle_4} onPress={() =>navigation.navigate('Scanner')}>
                <Text style={styles.appButtonText}>Onboard Meter</Text>
              </TouchableOpacity>                 
          </View>
      </View>
  )
